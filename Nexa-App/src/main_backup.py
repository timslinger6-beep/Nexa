...
class ColorMenu(Entity):
    ...
    def __init__(self):
        ...
        # Hue slider: range 0鈥?60, displays a rainbow texture
        ...
        # Saturation slider: range 0鈥?00, initial default 50, colored white background
        ...
        # Value (brightness) slider: range 0鈥?00, initial default 50, black-to-white gradient background
        ...
        # Alpha slider: range 0鈥?00, initial default 100, white background with left side transparent
...
class SunHandler(Entity):
    ...
    def __init__(self, **kwargs):
        ...
        - Creates a DirectionalLight (`self.sun`) with a 2048脳2048 shadow map resolution for high-quality shadows.
        ...
        try:
            self.radial_menu = RadialMenu(
                ...
                buttons=(
                    ...
                    # Button for "Coll" (collider) 鈥?currently a placeholder without callback
                    Button(
                        highlight_color=color.azure,
                        model='circle',
                        text='Coll',
